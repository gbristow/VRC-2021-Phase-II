...
class AprilTagVPS(object):
    ...
    def start(self):
        ...
        while True:
            ...
            if not self.tags_queue.empty():
                ...
                # logger.success(f"AT: FPS {avg:04.1f} \t Tags: {len(tags)}")
                last_loop = now
                i += 1
            else:
                time.sleep(0.01)
    ...
    def capture_loop(self):
        ...
        while True:
            ...
            if (self.img_queue.qsize() < max_depth) and (ret is True):
                ...
                # logger.success(f"AT: Placed an image!")
            time.sleep(0.01)
    ...
    def perception_loop(self):
        ...
        try:
            ...
            logger.exception("AT: Perception Loop Error")
            raise e
