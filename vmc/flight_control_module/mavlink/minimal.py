...
enums["MAV_AUTOPILOT"][5] = EnumEntry(
    "MAV_AUTOPILOT_GENERIC_WAYPOINTS_ONLY",
    """Generic autopilot only supporting simple waypoints""",
)
MAV_AUTOPILOT_GENERIC_WAYPOINTS_AND_SIMPLE_NAVIGATION_ONLY = (
    6  # Generic autopilot supporting waypoints and other simple navigation
)
# commands
enums["MAV_AUTOPILOT"][6] = EnumEntry(
    "MAV_AUTOPILOT_GENERIC_WAYPOINTS_AND_SIMPLE_NAVIGATION_ONLY",
...
enums["MAV_AUTOPILOT"][7] = EnumEntry(
    "MAV_AUTOPILOT_GENERIC_MISSION_FULL",
    """Generic autopilot supporting the full mission command set""",
)
MAV_AUTOPILOT_INVALID = 8  # No valid autopilot, e.g. a GCS or other MAVLink component
enums["MAV_AUTOPILOT"][8] = EnumEntry(
    "MAV_AUTOPILOT_INVALID",
    """No valid autopilot, e.g. a GCS or other MAVLink component""",
)
MAV_AUTOPILOT_PPZ = 9  # PPZ UAV - http://nongnu.org/paparazzi
enums["MAV_AUTOPILOT"][9] = EnumEntry(
...
enums["MAV_TYPE"][18] = EnumEntry(
    "MAV_TYPE_ONBOARD_CONTROLLER", """Onboard companion controller"""
)
MAV_TYPE_VTOL_DUOROTOR = (
    19  # Two-rotor VTOL using control surfaces in vertical operation in
)
# addition. Tailsitter.
enums["MAV_TYPE"][19] = EnumEntry(
    "MAV_TYPE_VTOL_DUOROTOR",
...
enums["MAV_MODE_FLAG"][1] = EnumEntry(
    "MAV_MODE_FLAG_CUSTOM_MODE_ENABLED", """0b00000001 Reserved for future use."""
)
MAV_MODE_FLAG_TEST_ENABLED = (
    2  # 0b00000010 system has a test mode enabled. This flag is intended for
)
# temporary system tests and should not be
# used for stable implementations.
enums["MAV_MODE_FLAG"][2] = EnumEntry(
    "MAV_MODE_FLAG_TEST_ENABLED",
    """0b00000010 system has a test mode enabled. This flag is intended for temporary system tests and should not be used for stable implementations.""",
)
MAV_MODE_FLAG_AUTO_ENABLED = (
    4  # 0b00000100 autonomous mode enabled, system finds its own goal
)
# positions. Guided flag can be set or not,
# depends on the actual implementation.
enums["MAV_MODE_FLAG"][4] = EnumEntry(
    "MAV_MODE_FLAG_AUTO_ENABLED",
    """0b00000100 autonomous mode enabled, system finds its own goal positions. Guided flag can be set or not, depends on the actual implementation.""",
)
MAV_MODE_FLAG_GUIDED_ENABLED = (
    8  # 0b00001000 guided mode enabled, system flies waypoints / mission
)
# items.
enums["MAV_MODE_FLAG"][8] = EnumEntry(
    "MAV_MODE_FLAG_GUIDED_ENABLED",
...
enums["MAV_MODE_FLAG"][16] = EnumEntry(
    "MAV_MODE_FLAG_STABILIZE_ENABLED",
    """0b00010000 system stabilizes electronically its attitude (and optionally position). It needs however further control inputs to move around.""",
)
MAV_MODE_FLAG_HIL_ENABLED = (
    32  # 0b00100000 hardware in the loop simulation. All motors / actuators are
)
# blocked, but internal software is full
# operational.
enums["MAV_MODE_FLAG"][32] = EnumEntry(
    "MAV_MODE_FLAG_HIL_ENABLED",
    """0b00100000 hardware in the loop simulation. All motors / actuators are blocked, but internal software is full operational.""",
)
MAV_MODE_FLAG_MANUAL_INPUT_ENABLED = 64  # 0b01000000 remote control input is enabled.
enums["MAV_MODE_FLAG"][64] = EnumEntry(
    "MAV_MODE_FLAG_MANUAL_INPUT_ENABLED",
    """0b01000000 remote control input is enabled.""",
)
MAV_MODE_FLAG_SAFETY_ARMED = (
    128  # 0b10000000 MAV safety set to armed. Motors are enabled / running / can
)
...
enums["MAV_MODE_FLAG"][128] = EnumEntry(
    "MAV_MODE_FLAG_SAFETY_ARMED",
...
# for a message.
enums["MAV_COMPONENT"][0] = EnumEntry(
    "MAV_COMP_ID_ALL",
...
MAV_COMP_ID_USER2 = (
    26  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][26] = EnumEntry(
    "MAV_COMP_ID_USER2",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER3 = (
    27  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][27] = EnumEntry(
    "MAV_COMP_ID_USER3",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER4 = (
    28  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][28] = EnumEntry(
    "MAV_COMP_ID_USER4",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER5 = (
    29  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][29] = EnumEntry(
    "MAV_COMP_ID_USER5",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER6 = (
    30  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][30] = EnumEntry(
    "MAV_COMP_ID_USER6",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER7 = (
    31  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][31] = EnumEntry(
    "MAV_COMP_ID_USER7",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER8 = (
    32  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][32] = EnumEntry(
    "MAV_COMP_ID_USER8",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER9 = (
    33  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][33] = EnumEntry(
    "MAV_COMP_ID_USER9",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER10 = (
    34  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][34] = EnumEntry(
    "MAV_COMP_ID_USER10",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER11 = (
    35  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][35] = EnumEntry(
    "MAV_COMP_ID_USER11",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER12 = (
    36  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][36] = EnumEntry(
    "MAV_COMP_ID_USER12",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER13 = (
    37  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][37] = EnumEntry(
    "MAV_COMP_ID_USER13",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER14 = (
    38  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][38] = EnumEntry(
    "MAV_COMP_ID_USER14",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER15 = (
    39  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][39] = EnumEntry(
    "MAV_COMP_ID_USER15",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER16 = (
    40  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][40] = EnumEntry(
    "MAV_COMP_ID_USER16",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER17 = (
    41  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][41] = EnumEntry(
    "MAV_COMP_ID_USER17",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER18 = (
    42  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][42] = EnumEntry(
    "MAV_COMP_ID_USER18",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER19 = (
    43  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][43] = EnumEntry(
    "MAV_COMP_ID_USER19",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER20 = (
    44  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][44] = EnumEntry(
    "MAV_COMP_ID_USER20",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER21 = (
    45  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][45] = EnumEntry(
    "MAV_COMP_ID_USER21",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER22 = (
    46  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][46] = EnumEntry(
    "MAV_COMP_ID_USER22",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER23 = (
    47  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][47] = EnumEntry(
    "MAV_COMP_ID_USER23",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER24 = (
    48  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][48] = EnumEntry(
    "MAV_COMP_ID_USER24",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER25 = (
    49  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][49] = EnumEntry(
    "MAV_COMP_ID_USER25",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER26 = (
    50  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][50] = EnumEntry(
    "MAV_COMP_ID_USER26",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER27 = (
    51  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][51] = EnumEntry(
    "MAV_COMP_ID_USER27",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER28 = (
    52  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][52] = EnumEntry(
    "MAV_COMP_ID_USER28",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER29 = (
    53  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][53] = EnumEntry(
    "MAV_COMP_ID_USER29",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER30 = (
    54  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][54] = EnumEntry(
    "MAV_COMP_ID_USER30",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER31 = (
    55  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][55] = EnumEntry(
    "MAV_COMP_ID_USER31",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER32 = (
    56  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][56] = EnumEntry(
    "MAV_COMP_ID_USER32",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER33 = (
    57  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][57] = EnumEntry(
    "MAV_COMP_ID_USER33",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER34 = (
    58  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][58] = EnumEntry(
    "MAV_COMP_ID_USER34",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER35 = (
    59  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][59] = EnumEntry(
    "MAV_COMP_ID_USER35",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER36 = (
    60  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][60] = EnumEntry(
    "MAV_COMP_ID_USER36",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER37 = (
    61  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][61] = EnumEntry(
    "MAV_COMP_ID_USER37",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER38 = (
    62  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][62] = EnumEntry(
    "MAV_COMP_ID_USER38",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER39 = (
    63  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][63] = EnumEntry(
    "MAV_COMP_ID_USER39",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER40 = (
    64  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][64] = EnumEntry(
    "MAV_COMP_ID_USER40",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER41 = (
    65  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][65] = EnumEntry(
    "MAV_COMP_ID_USER41",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER42 = (
    66  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][66] = EnumEntry(
    "MAV_COMP_ID_USER42",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER43 = (
    67  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][67] = EnumEntry(
    "MAV_COMP_ID_USER43",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_TELEMETRY_RADIO = (
    68  # Telemetry radio (e.g. SiK radio, or other component that emits
)
# RADIO_STATUS messages).
enums["MAV_COMPONENT"][68] = EnumEntry(
    "MAV_COMP_ID_TELEMETRY_RADIO",
    """Telemetry radio (e.g. SiK radio, or other component that emits RADIO_STATUS messages).""",
)
MAV_COMP_ID_USER45 = (
    69  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][69] = EnumEntry(
    "MAV_COMP_ID_USER45",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER46 = (
    70  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][70] = EnumEntry(
    "MAV_COMP_ID_USER46",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER47 = (
    71  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][71] = EnumEntry(
    "MAV_COMP_ID_USER47",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER48 = (
    72  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][72] = EnumEntry(
    "MAV_COMP_ID_USER48",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER49 = (
    73  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][73] = EnumEntry(
    "MAV_COMP_ID_USER49",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER50 = (
    74  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][74] = EnumEntry(
    "MAV_COMP_ID_USER50",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER51 = (
    75  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][75] = EnumEntry(
    "MAV_COMP_ID_USER51",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER52 = (
    76  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][76] = EnumEntry(
    "MAV_COMP_ID_USER52",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER53 = (
    77  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][77] = EnumEntry(
    "MAV_COMP_ID_USER53",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER54 = (
    78  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][78] = EnumEntry(
    "MAV_COMP_ID_USER54",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER55 = (
    79  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][79] = EnumEntry(
    "MAV_COMP_ID_USER55",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER56 = (
    80  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][80] = EnumEntry(
    "MAV_COMP_ID_USER56",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER57 = (
    81  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][81] = EnumEntry(
    "MAV_COMP_ID_USER57",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER58 = (
    82  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][82] = EnumEntry(
    "MAV_COMP_ID_USER58",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER59 = (
    83  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][83] = EnumEntry(
    "MAV_COMP_ID_USER59",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER60 = (
    84  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][84] = EnumEntry(
    "MAV_COMP_ID_USER60",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER61 = (
    85  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][85] = EnumEntry(
    "MAV_COMP_ID_USER61",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER62 = (
    86  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][86] = EnumEntry(
    "MAV_COMP_ID_USER62",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER63 = (
    87  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][87] = EnumEntry(
    "MAV_COMP_ID_USER63",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER64 = (
    88  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][88] = EnumEntry(
    "MAV_COMP_ID_USER64",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER65 = (
    89  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][89] = EnumEntry(
    "MAV_COMP_ID_USER65",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER66 = (
    90  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][90] = EnumEntry(
    "MAV_COMP_ID_USER66",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER67 = (
    91  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][91] = EnumEntry(
    "MAV_COMP_ID_USER67",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER68 = (
    92  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][92] = EnumEntry(
    "MAV_COMP_ID_USER68",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER69 = (
    93  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][93] = EnumEntry(
    "MAV_COMP_ID_USER69",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER70 = (
    94  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][94] = EnumEntry(
    "MAV_COMP_ID_USER70",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER71 = (
    95  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][95] = EnumEntry(
    "MAV_COMP_ID_USER71",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER72 = (
    96  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][96] = EnumEntry(
    "MAV_COMP_ID_USER72",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER73 = (
    97  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][97] = EnumEntry(
    "MAV_COMP_ID_USER73",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER74 = (
    98  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][98] = EnumEntry(
    "MAV_COMP_ID_USER74",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
MAV_COMP_ID_USER75 = (
    99  # Id for a component on privately managed MAVLink network. Can be used
)
# for any purpose but may not be published by
# components outside of the private network.
enums["MAV_COMPONENT"][99] = EnumEntry(
    "MAV_COMP_ID_USER75",
    """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""",
)
...
MAV_COMP_ID_MISSIONPLANNER = (
    190  # Component that can generate/supply a mission flight plan (e.g. GCS or
)
# developer API).
enums["MAV_COMPONENT"][190] = EnumEntry(
    "MAV_COMP_ID_MISSIONPLANNER",
    """Component that can generate/supply a mission flight plan (e.g. GCS or developer API).""",
)
MAV_COMP_ID_ONBOARD_COMPUTER = (
    191  # Component that lives on the onboard computer (companion computer) and
)
...
enums["MAV_COMPONENT"][191] = EnumEntry(
    "MAV_COMP_ID_ONBOARD_COMPUTER",
...
MAV_COMP_ID_PATHPLANNER = (
    195  # Component that finds an optimal path between points based on a certain
)
# constraint (e.g. minimum snap, shortest
# path, cost, etc.).
enums["MAV_COMPONENT"][195] = EnumEntry(
    "MAV_COMP_ID_PATHPLANNER",
...
enums["MAV_COMPONENT"][196] = EnumEntry(
    "MAV_COMP_ID_OBSTACLE_AVOIDANCE",
...
enums["MAV_COMPONENT"][236] = EnumEntry(
    "MAV_COMP_ID_ODID_TXRX_1",
...
enums["MAV_COMPONENT"][237] = EnumEntry(
    "MAV_COMP_ID_ODID_TXRX_2",
    """Open Drone ID transmitter/receiver (Bluetooth/WiFi/Internet).""",
)
...
enums["MAV_COMPONENT"][250] = EnumEntry(
    "MAV_COMP_ID_SYSTEM_CONTROL",
...
class MAVLink_heartbeat_message(MAVLink_message):
    ...
    def __init__(
        ...
        MAVLink_message.__init__(
            self, MAVLink_heartbeat_message.id, MAVLink_heartbeat_message.name
        )
...
class MAVLink(object):
    ...
    def __parse_char_legacy(self):
        ...
        if (
            ...
            mbuf = array.array(
                "B", self.buf[self.buf_index : self.buf_index + self.expected_length]
            )
    ...
    def check_signature(self, msgbuf, srcSystem, srcComponent):
        ...
        h.update(msgbuf[:-6])
        if (
            str(type(msgbuf)) == "<class 'bytes'>"
            or str(type(msgbuf)) == "<class 'bytearray'>"
        ):
            # Python 3
            sig1 = h.digest()[:6]
            sig2 = msgbuf[-6:]
    ...
    def decode(self, msgbuf):
        ...
        if len(mbuf) < csize:
            raise MAVError(
                "Bad message of type %s length %u needs %s" % (type, len(mbuf), csize)
            )
        mbuf = mbuf[:csize]
        try:
        ...
        try:
            ...
            raise MAVError(
                "Unable to instantiate MAVLink message of type %s : %s" % (type, emsg)
            )
        m._signed = sig_ok
        if m._signed:
